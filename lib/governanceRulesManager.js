...
function prepareFieldValues(event, context) {
  return {
...
function prepareRequestHeaders(event, context) {

}

function prepareRequestBody(event, context) {
...
GovernanceRulesManager.prototype.governRequest = function (config, userId, companyId, requestFields, requestHeaders, requestBody) {
